package com.svs.farm_app.searchable;
...
public class SearchableSpinner extends androidx.appcompat.widget.AppCompatSpinner implements View.OnTouchListener,
    ...
    private MyArrayAdapter _arrayAdapter;
    ...
    private void init() {
        ...
        _arrayAdapter = (MyArrayAdapter) getAdapter();
    ...
    public void setAdapter(SpinnerAdapter adapter) {
        Log.e(TAG, "setAdapter: start "+adapter.getClass().getSimpleName() );
        if (!_isFromInit) {
            _arrayAdapter = (MyArrayAdapter) adapter;
            if (!TextUtils.isEmpty(_strHintText) && !_isDirty) {
                Log.e(TAG, "setAdapter: something wrong with hint" );
                ArrayAdapter arrayAdapter = new ArrayAdapter(_context, android.R.layout
                        .simple_list_item_1, new String[]{_strHintText});
    ...
    public void onSearchableItemClicked(Object item, int position) {
        Log.e(TAG, "onSearchableItemClicked-i: "+item.toString() );
        Log.e(TAG, "onSearchableItemClicked-p: "+position);
        Log.e(TAG, "onSearchableItemClicked-oP: "+_items.indexOf(item) );
        Log.e(TAG, "onSearchableItemClicked-oP: "+_arrayAdapter.getOriginalList().indexOf(item) );
        Log.e(TAG, "onSearchableItemClicked: "+_items.size() );
        setSelection(_arrayAdapter.getOriginalList().indexOf(item));
...
//            onItemClickListener.onItemClick(getParent(),getAdapter().get,po);
    }
    ...
    public void setOnItemClickListener(OnItemClickListener l) {
        ...
        _searchableListDialog.setOnItemClickListener(onItemClickListener);
    }
