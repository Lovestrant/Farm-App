...
public class SearchableListDialog extends DialogFragment implements
    ...
    public static SearchableListDialog newInstance(List items) {
        Log.e(TAG, "newInstance: "+items.size() );
    ...
    private void setData(View rootView) {
        ...
        listAdapter = new MyArrayAdapter(getActivity(), android.R.layout.simple_list_item_1,
                items);
        ...
        _listViewItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Log.e(TAG, "onItemClick: "+listAdapter.getItem(position).toString() );
...
//    public MyArrayAdapter getListAdapter{
//        return
//    }
