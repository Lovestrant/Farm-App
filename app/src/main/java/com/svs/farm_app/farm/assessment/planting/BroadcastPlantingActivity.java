 ...
 * @author Benson
 */
public class BroadcastPlantingActivity extends BaseClass implements
	...
	Toolbar toolbar;
	private BroadcastPlantingActivity mContext;
	...
	public void onCreate(Bundle icicle) {
		...
		mContext = BroadcastPlantingActivity.this;
	...
	public void onClick(View v) {
		if (v == bBack) {
			...
			if (!"".equals(activityDate.trim())
					...
					&& !"".equals(remarks.trim())) {
				db.addFarmAssMajor(new FarmAssFormsMajor(farmID, FormTypes.BROADCASTING,
