 ...
 * @author Benson
 */
public class PotholingActivity extends BaseClass implements View.OnClickListener , DatePickerDialog.OnDateSetListener {
	...
	private PotholingActivity mContext;
	...
	public void onCreate(Bundle icicle) {
		...
		mContext = PotholingActivity.this;
	...
	private void initData() {
		...
		next = new Intent(mContext, RidgingActivity.class);
	...
	public void onClick(View v) {
		if (v == bBack) {
			...
			if (!"".equals(activityDate.trim())
					...
					&& !"".equals(remarks.trim())) {
				db.addFarmAssMajor(new FarmAssFormsMajor(farmID, FormTypes.POTHOLING,
