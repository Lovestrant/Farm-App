 ...
 * @author Wamae
 */
public class PloughingFragment extends Fragment implements View.OnClickListener  , DatePickerDialog.OnDateSetListener{
	...
	private void initView() {
		((LandPreparationActivity)getActivity()).getSupportActionBar().setTitle(R.string.title_ploughing);
	...
	public void onClick(View v) {
		if (v == bBack) {
			...
			if (!"".equals(activityDate.trim())
				...
				((LandPreparationActivity)mContext).majorFormStack.push(new FarmAssFormsMajor(farmID, FormTypes.PLOUGHING,
				...
				RippingFragment rippingFragment = new RippingFragment();
				insertFragment(R.id.fragment_container, rippingFragment, "ripping");
