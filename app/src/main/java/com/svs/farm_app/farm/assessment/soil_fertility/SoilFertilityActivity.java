...
public class SoilFertilityActivity extends BaseClass {

    private SoilFertilityActivity mContext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fragmentContainer != null) {
            ...
            MulchingFragment mulchingFragment = new MulchingFragment();

            insertFragment(R.id.fragment_container, mulchingFragment, "mulching");
        }

        mContext = SoilFertilityActivity.this;
        initView();
        initData();
    }
