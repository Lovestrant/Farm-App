 ...
 */
package com.svs.farm_app.farm.assessment.post_harvest;
 ...
 * @author Benson
 */
public class StalkDestructionActivity extends BaseClass implements View.OnClickListener , DatePickerDialog.OnDateSetListener {
    ...
    private StalkDestructionActivity mContext;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mContext = StalkDestructionActivity.this;
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            if (!"".equals(activityDate.trim())
                ...
                MyAlerts.toActivityDialog(mContext,R.string.saved_offline,farmAssessment.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP));
            } else {
