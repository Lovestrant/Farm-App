 ...
 * @author Benson
 */
public class GapFillingActivity extends BaseClass implements
	...
	Toolbar toolbar;
	private GapFillingActivity mContext;
	...
	public void onCreate(Bundle icicle) {
		...
		mContext = GapFillingActivity.this;
	...
	public void onClick(View v) {
		if (v == bBack) {
			...
			if (!"".equals(activityDate.trim())
					...
					&& !"".equals(remarks.trim())) {
				db.addFarmAssMajor(new FarmAssFormsMajor(farmID, FormTypes.GAP_FILLING,
	...
	private void initData() {
		...
		previous = new Intent(mContext, ReplantingActivity.class);
		previous.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);

		next = new Intent(mContext, ThinningActivity.class);

		d1 = new Date();
		collectDate = dateFormat.format(d1);
