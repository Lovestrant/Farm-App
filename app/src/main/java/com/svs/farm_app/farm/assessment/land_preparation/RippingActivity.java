 ...
 * @author Benson
 */
public class RippingActivity extends BaseClass implements OnClickListener , DatePickerDialog.OnDateSetListener {
	...
	Toolbar toolbar;
	private RippingActivity mContext;
	...
	private void initData() {
		...
		next = new Intent(mContext, PotholingActivity.class);
	...
	public void onClick(View v) {
		if (v == rbTractor) {
			...
			if (!"".equals(activityDate.trim())
					...
					&& !"".equals(remarks.trim())) {
				db.addFarmAssMajor(new FarmAssFormsMajor(farmID, FormTypes.RIPPING,
