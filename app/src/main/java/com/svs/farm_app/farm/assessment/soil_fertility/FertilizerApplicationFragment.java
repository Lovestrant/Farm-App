...
public class FertilizerApplicationFragment extends Fragment implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    private Date date;
    ...
    private void initView() {
        //((SoilFertilityActivity) getActivity()).getSupportActionBar().setTitle(R.string.title_fertilizer_one);
        setToolbarTitle();
        bBack.setText("back");
        bNext.setText("Next");
    }
    ...
    private void setToolbarTitle() {
        if (formTypeID == FormTypes.FERTILIZER_BASAL_D_COMPOUND) {

            ((SoilFertilityActivity) getActivity()).getSupportActionBar().setTitle(R.string.title_fertilizer_one);

        } else if (formTypeID == FormTypes.FERTILIZER_TOP_DRESSING_UREA) {

            ((SoilFertilityActivity) getActivity()).getSupportActionBar().setTitle(R.string.title_fertilizer_two);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            if (!"".equals(activityDate.trim())
                ...
                ((SoilFertilityActivity) mContext).majorFormStack.push(new FarmAssFormsMajor(farmID, formTypeID,
                        "none", activityDate, familyHours, hiredHours,
                        moneyOut, remarks, userID, collectDate, String
                        .valueOf(latitude), String.valueOf(longitude), companyID));
                ...
                if (formTypeID == FormTypes.FERTILIZER_BASAL_D_COMPOUND) {
                    ...
                    bundle.putString("form_type_id", FormTypes.FERTILIZER_TOP_DRESSING_UREA);
                    fertilizerFragment.setArguments(bundle);

                    insertFragment(R.id.fragment_container, fertilizerFragment, FormTypes.FERTILIZER_TOP_DRESSING_UREA);
                    ...
                    Bundle bundle = new Bundle();
                    bundle.putString("form_type_id", FormTypes.FOLIAR_FEED_ONE);
                    fertilizerFragment.setArguments(bundle);

                    insertFragment(R.id.fragment_container, fertilizerFragment, FormTypes.FOLIAR_FEED_ONE);
                    ((SoilFertilityActivity) getActivity()).getSupportActionBar().setTitle(R.string.title_foliar_app_one);
