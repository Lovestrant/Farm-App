 ...
 * @author Wamae
 */
public class PotholingFragment extends Fragment implements View.OnClickListener  , DatePickerDialog.OnDateSetListener{
	...
	public void onClick(View v) {
		if (v == bBack) {
			...
			if (!"".equals(activityDate.trim())
				...
				((LandPreparationActivity)mContext).majorFormStack.push(new FarmAssFormsMajor(farmID, FormTypes.POTHOLING,
				...
				RidgingFragment ridgingFragment = new RidgingFragment();
				insertFragment(R.id.fragment_container, ridgingFragment, "ridging");
