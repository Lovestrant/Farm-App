 ...
 * @author Benson
 */
public class ThinningActivity extends BaseClass implements OnClickListener , DatePickerDialog.OnDateSetListener {
	...
	Toolbar toolbar;
	private ThinningActivity mContext;
	...
	public void onCreate(Bundle icicle) {
		...
		mContext = ThinningActivity.this;
	...
	private void initData() {
		...
		previous = new Intent(mContext, GapFillingActivity.class);
	...
	public void onClick(View v) {
		if (v == bBack) {
			...
			if (!"".equals(activityDate.trim())
					...
					&& !"".equals(remarks.trim())) {
				db.addFarmAssMajor(new FarmAssFormsMajor(farmID, FormTypes.THINNING,
				...
				MyAlerts.toActivityDialog(mContext,R.string.saved_offline,farmAssessment);
			} else {
