 ...
 * @author Benson
 */
public class GradingActivity extends BaseClass implements View.OnClickListener , DatePickerDialog.OnDateSetListener {
    ...
    private GradingActivity mContext;
    ...
    private void initData() {
        ...
        cd = new ConnectionDetector(GradingActivity.this);
        db = new DatabaseHandler(GradingActivity.this);
        ...
        next = new Intent(mContext, BailingActivity.class).putExtra("form_type_id", formTypeID2);
