 ...
 */
package com.svs.farm_app.farm.assessment.weeding;
 ...
 * @author Benson
 */
public class WeedingActivity extends BaseClass implements View.OnClickListener, DatePickerDialog.OnDateSetListener {
    ...
    private WeedingActivity mContext;
	...
	private void setToolbarTitle() {
		if(formTypeID.equals(FormTypes.WEEDING_ONE)){
			getSupportActionBar().setTitle(R.string.weeding_one);
		}else if(formTypeID.equals(FormTypes.WEEDING_TWO)){
			getSupportActionBar().setTitle(R.string.weeding_two);
		}else if(formTypeID.equals(FormTypes.WEEDING_THREE)){
			getSupportActionBar().setTitle(R.string.weeding_three);
		}else if(formTypeID.equals(FormTypes.WEEDING_FOUR)){
			getSupportActionBar().setTitle(R.string.weeding_four);
		}
	}
	...
	public void onClick(View v) {
		if (v == bBack) {
			...
			if (!"".equals(activityDate) && !"".equals(familyHours)
					&& !"".equals(hiredHours) && !"".equals(moneyOut)
					&& !"".equals(remarks)) {
