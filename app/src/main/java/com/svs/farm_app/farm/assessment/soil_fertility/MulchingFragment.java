...
public class MulchingFragment extends Fragment implements View.OnClickListener  , DatePickerDialog.OnDateSetListener{
    private Date date;
    ...
    private void initView() {
        ((SoilFertilityActivity)getActivity()).getSupportActionBar().setTitle(R.string.title_mulching);
        //((SoilFertilityActivity)getActivity()).getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);
        //((SoilFertilityActivity)getActivity()).getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        bBack.setText("back");
        bNext.setText("Next");
    }
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            if (!"".equals(activityDate.trim())
                ...
                /*db.addFarmAssMajor(new FarmAssFormsMajor(farmID, FORM_TYPE_ID,
                ...
                ((SoilFertilityActivity)mContext).majorFormStack.push(new FarmAssFormsMajor(farmID, FORM_TYPE_ID,
                        "none", activityDate, familyHours, hiredHours,
                        moneyOut, remarks, userID, collectDate, String
                        .valueOf(latitude), String.valueOf(longitude), companyID));

//                List<FarmAssFormsMajor> mulching = DataUtils.makeSingleList(new FarmAssFormsMajor(farmID, FORM_TYPE_ID,
//                        "none", activityDate, familyHours, hiredHours,
//                        moneyOut, remarks, userID, collectDate, String
//                        .valueOf(latitude), String.valueOf(longitude), companyID));

                CompostFragment compostFragment = new CompostFragment();
                insertFragment(R.id.fragment_container, compostFragment, "compost");
