...
public class LandClearingFragment extends Fragment implements View.OnClickListener  , DatePickerDialog.OnDateSetListener{
    private Date date;
    ...
    private void initView() {
        ((LandPreparationActivity)getActivity()).getSupportActionBar().setTitle(R.string.title_land_clearing);
        ((LandPreparationActivity)getActivity()).getSupportActionBar().setDefaultDisplayHomeAsUpEnabled(true);
        ((LandPreparationActivity)getActivity()).getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    public void onClick(View v) {
        if (v == bBack) {
            ...
            if (!"".equals(activityDate.trim())
                ...
                ((LandPreparationActivity)mContext).majorFormStack.push(new FarmAssFormsMajor(farmID, FormTypes.LAND_CLEARING,
                ...
                PloughingFragment ploughingFragment = new PloughingFragment();
                insertFragment(R.id.fragment_container, ploughingFragment, "ploughing");
