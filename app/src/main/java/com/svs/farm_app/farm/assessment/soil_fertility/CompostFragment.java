 ...
 * @author Benson
 */
public class CompostFragment extends Fragment implements View.OnClickListener  , DatePickerDialog.OnDateSetListener{
	...
	private void initView() {
		((SoilFertilityActivity)getActivity()).getSupportActionBar().setTitle(R.string.title_compost);
		bBack.setText("back");
		bNext.setText("Next");
	}
	...
	public void onClick(View v) {
		if (v == bBack) {
			...
			if (!"".equals(activityDate.trim())
				...
				((SoilFertilityActivity)mContext).majorFormStack.push(new FarmAssFormsMajor(farmID, FormTypes.COMPOST,
						"none", activityDate, familyHours, hiredHours,
						moneyOut, remarks, userID, collectDate, String
						.valueOf(latitude), String.valueOf(longitude), companyID));

				ManureFragment manureFragment = new ManureFragment();
				insertFragment(R.id.fragment_container, manureFragment, "manure");
